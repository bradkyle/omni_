...
from omni.interfaces.registration import affordance, task


class GeminiInterface(object):
    ...
    def _invoke(self, endpoint, payload, params=None, pub=True):
    ...
    def get_symbols(self):
        ...
        return self._invoke(endpoint, payload, pub=True)
    ...
    def get_trade_history(self, symbol, since=None, limit_trades=None, include_breaks=None):
        ...
        return self._invoke(endpoint, payload, params, pub=True)
    ...
    def get_active_orders(self):
        ...
        return self._invoke(endpoint, payload, pub=False)
    ...
    def get_profit(self):
        """
        Returns the amount of profit incurred for the acting duration
    ...
    def get_loss(self):
        """
        Returns the amount of loss incurred for the acting duration
        between the current step and the previous step.
        """
        return NotImplemented
