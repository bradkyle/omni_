...
task(entry_point='omni.interfaces.base.tasks:step_loss', per_step = 0.00001)
...
for key_set in [
    ...
    task(entry_point='omni.interfaces.markets.gemini:profit_over_time', key_set=key_set)
